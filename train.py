...
if __name__ == '__main__':
    ...
    # *****************************************************************************************
    parser.add_argument('--weights', type=str, default='yolov4-csp.weights', help='initial weights path')
    # ***********************************************************************
    parser.add_argument('--cfg', type=str, default='models/yolov4-csp.cfg', help='model.yaml path')
    # *****************************************************************************************
